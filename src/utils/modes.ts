...
export type ModeConfig = {
	...
	strategy?: "ask" | "write" | "research" | "raw" // System prompt generation strategy
...
export const defaultModes: ModeConfig[] = [
	...
	},
	{
		...
		tools: ["read_file", "list_files", "search_files", "dataview_query", "write_to_file", "edit_file", "use_mcp_tool", "access_mcp_resource", "manage_files"],
		strategy: "write",
		customInstructions:
...
export function getAllModes(customModes?: ModeConfig[]): ModeConfig[] {
	...
	return allModes.filter(mode => mode.enabled !== false)
}
