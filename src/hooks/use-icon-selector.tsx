...
export const DEFAULT_COMMAND_ICONS = [
	...
	{ name: 'square-pen', icon: SquarePen, label: '编写' },
	...
	// 新增的图标
	{ name: 'layers', icon: Layers, label: '层级' },
	{ name: 'folder-open', icon: FolderOpen, label: '文件夹' },
	{ name: 'users', icon: Users, label: '用户' },
	{ name: 'home', icon: Home, label: '家居' },
	{ name: 'palette', icon: Palette, label: '调色板' },
	{ name: 'calculator', icon: Calculator, label: '计算器' },
	{ name: 'building-2', icon: Building2, label: '建筑' },
	{ name: 'shopping-cart', icon: ShoppingCart, label: '购物车' },
	{ name: 'graduation-cap', icon: GraduationCap, label: '学位帽' },
	{ name: 'scroll-text', icon: ScrollText, label: '文本' },
	{ name: 'table', icon: Table, label: '表格' },
]
